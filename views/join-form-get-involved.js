...
module.exports = ({ error, loading }, dispatch) => {
  ...
  return html`
    <div class="has-text-centered">
      <form class="box has-text-centered" method="POST" onsubmit="${handleForm(dispatch, { type: 'contactForm:submitSignup', url: 'https://liquid.us/get_involved' })}">
        ...
        <div class="field has-addons join-input-field">
          <div class="${`control is-expanded has-icons-left ${error ? 'has-icons-right' : ''}`}">
            <textarea class="textarea" name="message" required placeholder="My background and skills include ..." />
          </div>
