...
const joinForm = require('./join-form-organize')
...
module.exports = (state, dispatch) => {
  return html`
    ...
    <section onconnected="${activateScrollReveal}" class="hero is-link is-bold is-fullheight subtract-toolbar">
      <div class="hero-body">
        <div class="container reveal">
          <h2 class="title is-2 is-size-1-desktop is-size-3-mobile has-text-centered delayed">Advocate. Organize. Win.</h2>
          <br />
          <br />
          <div class="columns">
            <div class="column">
    ...
    <section class="hero is-light is-bold is-fullheight">
      <div class="hero-body">
        <div class="container">
          <h2 class="title is-3 is-size-2-desktop is-size-3-mobile has-text-centered reveal">The future of organizing is digital</h2>
          <br />
          <br />
          <br />
          <div class="columns has-text-centered">
            ...
            <div class="column">
              <h2 class="title is-4 has-text-centered">Build support for your priorities</h2>
          ...
          <p class="subtitle is-4 is-size-4-desktop reveal">Many organizations have it backward. Raising money is their first priority.
          <br /><br />
          We know from experience that it doesn't need to be this way.
          <br /><br />
          You can focus on the critical issues. Spend your time educating voters and increasing participation. And have faith that doing so will develop the grassroots support you need to grow and fund your organization.</p>
          <br />
          <br />
          <br />
        </div>
    ...
    <div class="section has-text-centered">
      <p class="is-size-7 has-text-grey">Icon images by priyanka, KonKapp, Maxim Basinski, Delwar Hossain, Maxim Kulikov, flatart, jugalbandi, Turkkub, zidney, Max Hancock, adrien coquet, Adiba Taj, Wilson Joseph from The Noun Project.</p>
    </div>
  `
}
